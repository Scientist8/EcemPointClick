...
public class Square4 : RaycastableBase
{

    private Vector3 initialPos;
    public override void OnRaycastHit()
    {
        Debug.Log("Square4 hit");

        EventsManager.Instance.ClickedSquare4();
    }
    ...
    {
        Debug.Log("Clicked on original square, setting initial position");
